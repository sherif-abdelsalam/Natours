...
var logoutBt = document.querySelector('.logout_bt');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-settings');
var bookTourBt = document.getElementById('book-tour');
if (loginForm) {
...
if (logoutBt) {
  logoutBt.addEventListener('click', _logout.logout);
}
...
if (bookTourBt) {
  console.log('sd;fjd');
  bookTourBt.addEventListener('click', /*#__PURE__*/function () {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ...
            tourId = bookTourBt.dataset.tourId;
            console.log(tourId);
            _context2.n = 1;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41575" + '/');
