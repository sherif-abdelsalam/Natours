      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          if (response.ok) {
            ...
            alert("Login failed: ".concat(data.message));
          }
          _context.n = 4;
          break;
        case 3:
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          ...
          _t = _context.v;
          console.log(_t);
          (0, _alerts.showAlert)('error', 'Error Loggint out. Try Again!');
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[0, 3]]);
